...
class Plot:
    ...
    def addPoint(self, xVal=0, yVal=0, style="o", color="blue"):
        ...
        Args:
            xVal (int, optional): X coordinate. Defaults to 0.
            yVal (int, optional): Y coordinate. Defaults to 0.
            style (str, optional): Style of point (options: https://matplotlib.org/stable/api/markers_api.html). 
                                   Defaults to "o".
            color (str, optional): Color as a name or hex value. Defaults to "blue".
        """
        self._points.append(
